...
export const instructions = [{
    ...
    name: "Add Word",
    architecture: "MIPS I",
    bits: [[31, 26, "SPECIAL", "000000"], [25, 21, "rs", ""], [20, 16, "rt", ""], [15, 11, "rd", ""], [10, 6, "0", "00000"], [5, 0, "ADD", "100000"]],
    format: "ADD rd, rs, rt [R-type]",
    ...
    architecture: "MIPS I",
    bits: [[31, 26, "ADDI", "001000"], [25, 21, "rs", ""], [20, 16, "rt", ""], [15, 0, "immediate", ""]],
    format: "ADDI rt, rs, immediate [I-type]",
    ...
    architecture: "MIPS I",
    bits: [[31, 26, "ADDIU", "001001"], [25, 21, "rs", ""], [20, 16, "rt", ""], [15, 0, "immediate", ""]],
    format: "ADDIU rt, rs, immediate [I-type]",
    ...
    architecture: "MIPS I",
    bits: [[31, 26, "SPECIAL", "000000"], [25, 21, "rs", ""], [20, 16, "rt", ""], [15, 11, "rd", ""], [10, 6, "0", "00000"], [5, 0, "ADDU", "100001"]],
    ...
    name: "And",
    architecture: "MIPS I",
    bits: [[31, 26, "SPECIAL", "000000"], [25, 21, "rs", ""], [20, 16, "rt", ""], [15, 11, "rd", ""], [10, 6, "0", "00000"], [5, 0, "AND", "100100"]],
    format: "AND rd, rs, rt [R-type]",
    ...
    name: "And Immediate",
    architecture: "MIPS I",
    bits: [[31, 26, "ANDI", "001100"], [25, 21, "rs", ""], [20, 16, "rt", ""], [15, 0, "immediate", ""]],
    format: "ANDI rt, rs, immediate [I-type]",
    ...
    architecture: "MIPS I",
    bits: [[31, 26, "BEQ", "000100"], [25, 21, "rs", ""], [20, 16, "rt", ""], [15, 0, "offset", ""]],
    format: "BEQ rs, rt, offset [I-type]",
    ...
    bits: [[31, 26, "BEQL", "010100"], [25, 21, "rs", ""], [20, 16, "rt", ""], [15, 0, "offset", ""]],
    format: "BEQL rs, rt, offset [I-type]",
    ...
    architecture: "MIPS I",
    bits: [[31, 26, "REGIMM", "000001"], [25, 21, "rs", ""], [20, 16, "BGEZ", "00001"], [15, 0, "offset", ""]],
    format: "BGEZ rs, offset [I-type]",
    ...
    architecture: "MIPS I",
    bits: [[31, 26, "REGIMM", "000001"], [25, 21, "rs", ""], [20, 16, "BGEZAL", "10001"], [15, 0, "offset", ""]],
    format: "BGEZAL rs, offset [I-type]",
    purpose: "To test a GPR then do a PC-relative conditional procedure call.",
    description: "if (rs >= 0) then procedure_call<br>Place the return address link in GPR 31. The return link is the address of the second instruction following the branch, where execution would continue after a procedure call.<br>An 18-bit signed offset (the 16-bit offset field shifted left 2 bits) is added to the address of the instruction following the branch (not the branch itself), in the branch delay slot, to form a PC-relative effective target address.<br>If the contents of GPR rs are greater than or equal to zero (sign bit is 0), branch to the effective target address after the instruction in the delay slot is executed.",
    ...
    operation: "I:<br>&emsp;tgt_offset <- sign_extend(offset || 02)<br>&emsp;condition <- GPR[rs] >= 0GPRLEN<br>&emsp;GPR[31] <- PC + 8<br>I+1:<br>&emsp;if condition then<br>&emsp;&emsp;PC <- PC + tgt_offset<br>&emsp;endif",
    exceptions: "None.",
    programming_notes: "With the 18-bit signed instruction offset, the conditional branch range is ± 128 KBytes. Use jump and link (JAL) or jump and link register (JALR) instructions for procedure calls to more distant addresses.",
    implementation_notes: ""
}, {
    symbol: "BGEZALL",
    name: "Branch on Greater Than or Equal to Zero and Link Likely",
    architecture: "MIPS II",
    bits: [[31, 26, "REGIMM", "000001"], [25, 21, "rs", ""], [20, 16, "BGEZALL", "10011"], [15, 0, "offset", ""]],
    format: "BGEZALL rs, offset [I-type]",
    ...
    description: "if (rs >= 0) then procedure_call_likely<br>Place the return address link in GPR 31. The return link is the address of the second instruction following the branch, where execution would continue after a procedure call.<br>An 18-bit signed offset (the 16-bit offset field shifted left 2 bits) is added to the address of the instruction following the branch (not the branch itself), in the branch delay slot, to form a PC-relative effective target address.<br>If the contents of GPR rs are greater than or equal to zero (sign bit is 0), branch to the effective target address after the instruction in the delay slot is executed. If the branch is not taken, the instruction in the delay slot is not executed.",
    restrictions: "GPR 31 must not be used for the source register rs, because such an instruction does not have the same effect when re-executed. The result of executing such an instruction is undefined. This restriction permits an exception handler to resume execution by re-executing the branch when an exception occurs in the branch delay slot.",
    operation: "I:<br>&emsp;tgt_offset <- sign_extend(offset || 02)<br>&emsp;condition <- GPR[rs] >= 0GPRLEN<br>&emsp;GPR[31] <- PC + 8<br>I+1:<br>&emsp;if condition then<br>&emsp;&emsp;PC <- PC + tgt_offset<br>&emsp;else<br>&emsp;&emsp;NullifyCurrentInstruction()<br>&emsp;endif",
    exceptions: "Reserved Instruction",
    programming_notes: "With the 18-bit signed instruction offset, the conditional branch range is ± 128 KBytes. Use jump and link (JAL) or jump and link register (JALR) instructions for procedure calls to more distant addresses.",
    implementation_notes: ""
}, {
    symbol: "BGEZL",
    name: "Branch on Greater Than or Equal to Zero Likely",
    architecture: "MIPS II",
    bits: [[31, 26, "REGIMM", "000001"], [25, 21, "rs", ""], [20, 16, "BGEZL", "00011"], [15, 0, "offset", ""]],
    format: "BGEZL rs, offset [I-type]",
    ...
    architecture: "MIPS I",
    bits: [[31, 26, "BGTZ", "000111"], [25, 21, "rs", ""], [20, 16, "0", "00000"], [15, 0, "offset", ""]],
    format: "BGTZ rs, offset [I-type]",
    purpose: "To test a GPR then do a PC-relative conditional branch.",
    ...
    architecture: "MIPS II",
    bits: [[31, 26, "BGTZL", "010111"], [25, 21, "rs", ""], [20, 16, "0", "00000"], [15, 0, "offset", ""]],
    format: "BGTZL rs, offset [I-type]",
    purpose: "To test a GPR then do a PC-relative conditional branch; execute the delay slot only if the branch is taken.",
    ...
    architecture: "MIPS I",
    bits: [[31, 26, "BLEZ", "000110"], [25, 21, "rs", ""], [20, 16, "0", "00000"], [15, 0, "offset", ""]],
    format: "BLEZ rs, offset [I-type]",
    purpose: "To test a GPR then do a PC-relative conditional branch.",
    ...
    architecture: "MIPS II",
    bits: [[31, 26, "BLEZL", "010110"], [25, 21, "rs", ""], [20, 16, "0", "00000"], [15, 0, "offset", ""]],
    format: "BLEZL rs, offset [I-type]",
    purpose: "To test a GPR then do a PC-relative conditional branch; execute the delay slot only if the branch is taken.",
    ...
    architecture: "MIPS I",
    bits: [[31, 26, "REGIMM", "000001"], [25, 21, "rs", ""], [20, 16, "BLTZ", "00000"], [15, 0, "offset", ""]],
    format: "BLTZ rs, offset [I-type]",
    purpose: "To test a GPR then do a PC-relative conditional branch.",
    description: "if (rs < 0) then branch<br>An 18-bit signed offset (the 16-bit offset field shifted left 2 bits) is added to the address of the instruction following the branch (not the branch itself), in the branch delay slot, to form a PC-relative effective target address.<br>If the contents of GPR rs are less than zero (sign bit is 1), branch to the effective target address after the instruction in the delay slot is executed.",
    restrictions: "None.",
    operation: "I:<br>&emsp;tgt_offset <- sign_extend(offset || 02)<br>&emsp;condition <- GPR[rs] < 0GPRLEN<br>I+1:<br>&emsp;if condition then<br>&emsp;&emsp;PC <- PC + tgt_offset<br>&emsp;endif",
    exceptions: "None.",
    programming_notes: "With the 18-bit signed instruction offset, the conditional branch range is ± 128 KBytes. Use jump (J) or jump register (JR) instructions to branch to more distant addresses.",
    ...
    architecture: "MIPS I",
    bits: [[31, 26, "REGIMM", "000001"], [25, 21, "rs", ""], [20, 16, "BLTZAL", "10000"], [15, 0, "offset", ""]],
    format: "BLTZAL rs, offset [I-type]",
    purpose: "To test a GPR then do a PC-relative conditional procedure call.",
    description: "if (rs < 0) then procedure_call<br>Place the return address link in GPR 31. The return link is the address of the second instruction following the branch (not the branch itself), where execution would continue after a procedure call.<br>An 18-bit signed offset (the 16-bit offset field shifted left 2 bits) is added to the address of the instruction following the branch, in the branch delay slot, to form a PC-relative effective target address.<br>If the contents of GPR rs are less than zero (sign bit is 1), branch to the effective target address after the instruction in the delay slot is executed.",
    restrictions: "GPR 31 must not be used for the source register rs, because such an instruction does not have the same effect when re-executed. The result of executing such an instruction is undefined. This restriction permits an exception handler to resume execution by re-executing the branch when an exception occurs in the branch delay slot.",
    operation: "I:<br>&emsp;tgt_offset <- sign_extend(offset || 02)<br>&emsp;condition <- GPR[rs] < 0GPRLEN<br>&emsp;GPR[31] <- PC + 8<br>I+1:<br>&emsp;if condition then<br>&emsp;&emsp;PC <- PC + tgt_offset<br>&emsp;endif",
    exceptions: "None.",
    programming_notes: "With the 18-bit signed instruction offset, the conditional branch range is ± 128 KBytes. Use jump and link (JAL) or jump and link register (JALR) instructions for procedure calls to more distant addresses.",
    ...
    symbol: "BLTZALL",
    name: "Branch on Less Than Zero And Link Likely",
    architecture: "MIPS II",
    bits: [[31, 26, "REGIMM", "000001"], [25, 21, "rs", ""], [20, 16, "BLTZALL", "10010"], [15, 0, "offset", ""]],
    format: "BLTZALL rs, offset [I-type]",
    purpose: "To test a GPR then do a PC-relative conditional procedure call; execute the delay slot only if the branch is taken.",
    description: "if (rs < 0) then procedure_call_likely<br>Place the return address link in GPR 31. The return link is the address of the second instruction following the branch (not the branch itself), where execution would continue after a procedure call.<br>An 18-bit signed offset (the 16-bit offset field shifted left 2 bits) is added to the address of the instruction following the branch, in the branch delay slot, to form a PC-relative effective target address.<br>If the contents of GPR rs are less than zero (sign bit is 1), branch to the effective target address after the instruction in the delay slot is executed. If the branch is not taken, the instruction in the delay slot is not executed.",
    restrictions: "GPR 31 must not be used for the source register rs, because such an instruction does not have the same effect when re-executed. The result of executing such an instruction is undefined. This restriction permits an exception handler to resume execution by re-executing the branch when an exception occurs in the branch delay slot.",
    operation: "I:<br>&emsp;tgt_offset <- sign_extend(offset || 02)<br>&emsp;condition <- GPR[rs] < 0GPRLEN<br>&emsp;GPR[31] <- PC + 8<br>I+1:<br>&emsp;if condition then<br>&emsp;&emsp;PC <- PC + tgt_offset<br>&emsp;else<br>&emsp;&emsp;NullifyCurrentInstruction()<br>&emsp;endif",
    exceptions: "Reserved Instruction",
    programming_notes: "With the 18-bit signed instruction offset, the conditional branch range is ± 128 KBytes. Use jump and link (JAL) or jump and link register (JALR) instructions for procedure calls to more distant addresses.",
    ...
    symbol: "BLTZL",
    name: "Branch on Less Than Zero Likely",
    architecture: "MIPS II",
    bits: [[31, 26, "REGIMM", "000001"], [25, 21, "rs", ""], [20, 16, "BLTZL", "00010"], [15, 0, "offset", ""]],
    format: "BLTZL rs, offset [I-type]",
    purpose: "To test a GPR then do a PC-relative conditional branch; execute the delay slot only if the branch is taken.",
    description: "if (rs < 0) then branch_likely<br>An 18-bit signed offset (the 16-bit offset field shifted left 2 bits) is added to the address of the instruction following the branch (not the branch itself), in the branch delay slot, to form a PC-relative effective target address.<br>If the contents of GPR rs are less than zero (sign bit is 1), branch to the effective target address after the instruction in the delay slot is executed. If the branch is not taken, the instruction in the delay slot is not executed.",
    restrictions: "None.",
    operation: "I:<br>&emsp;tgt_offset <- sign_extend(offset || 02)<br>&emsp;condition <- GPR[rs] < 0GPRLEN<br>I+1:<br>&emsp;if condition then<br>&emsp;&emsp;PC <- PC + tgt_offset<br>&emsp;else<br>&emsp;&emsp;NullifyCurrentInstruction()<br>&emsp;endif",
    exceptions: "Reserved Instruction",
    programming_notes: "With the 18-bit signed instruction offset, the conditional branch range is ± 128 KBytes. Use jump (J) or jump register (JR) instructions to branch to more distant addresses.",
    ...
    architecture: "MIPS I",
    bits: [[31, 26, "BNE", "000101"], [25, 21, "rs", ""], [20, 16, "rt", ""], [15, 0, "offset", ""]],
    format: "BNE rs, rt, offset [I-type]",
    purpose: "To compare GPRs then do a PC-relative conditional branch.",
    ...
    architecture: "MIPS II",
    bits: [[31, 26, "BNEL", "010101"], [25, 21, "rs", ""], [20, 16, "rt", ""], [15, 0, "offset", ""]],
    format: "BNEL rs, rt, offset [I-type]",
    purpose: "To compare GPRs then do a PC-relative conditional branch; execute the delay slot only if the branch is taken.",
    ...
    name: "Breakpoint",
    architecture: "MIPS I",
    bits: [[31, 26, "SPECIAL", "000000"], [25, 6, "code", ""], [5, 0, "BREAK", "001101"]],
    format: "BREAK [R-type]",
    ...
    architecture: "MIPS I",
    bits: [[31, 26, "COP0", "010000"], [25, 0, "cop_fun", ""]],
    format: "COP0 cop_fun [I-type]",
    ...
    name: "Coprocessor Operation",
    architecture: "MIPS I",
    bits: [[31, 26, "COP1", "010001"], [25, 0, "cop_fun", ""]],
    format: "COP1 cop_fun [I-type]",
    purpose: "To execute a coprocessor instruction.",
    ...
    name: "Coprocessor Operation",
    architecture: "MIPS I",
    bits: [[31, 26, "COP2", "010010"], [25, 0, "cop_fun", ""]],
    format: "COP2 cop_fun [I-type]",
    purpose: "To execute a coprocessor instruction.",
    ...
    name: "Coprocessor Operation",
    architecture: "MIPS I",
    bits: [[31, 26, "COP3", "010011"], [25, 0, "cop_fun", ""]],
    format: "COP3 cop_fun [I-type]",
    purpose: "To execute a coprocessor instruction.",
    ...
    symbol: "DADD",
    name: "Doubleword Add",
    architecture: "MIPS III",
    bits: [[31, 26, "SPECIAL", "000000"], [25, 21, "rs", ""], [20, 16, "rt", ""], [15, 11, "rd", ""], [10, 6, "0", "00000"], [5, 0, "DADD", "101100"]],
    format: "DADD rd, rs, rt [R-type]",
    ...
    architecture: "MIPS III",
    bits: [[31, 26, "DADDI", "011000"], [25, 21, "rs", ""], [20, 16, "rt", ""], [15, 0, "immediate", ""]],
    format: "DADDI rt, rs, immediate [I-type]",
    ...
    architecture: "MIPS III",
    bits: [[31, 26, "DADDIU", "011001"], [25, 21, "rs", ""], [20, 16, "rt", ""], [15, 0, "immediate", ""]],
    format: "DADDIU rt, rs, immediate [I-type]",
    ...
    architecture: "MIPS III",
    bits: [[31, 26, "SPECIAL", "000000"], [25, 21, "rs", ""], [20, 16, "rt", ""], [15, 11, "rd", ""], [10, 6, "0", "00000"], [5, 0, "DADDU", "101101"]],
    format: "DADDU rd, rs, rt [R-type]",
    ...
    architecture: "MIPS III",
    bits: [[31, 26, "SPECIAL", "000000"], [25, 21, "rs", ""], [20, 16, "rt", ""], [15, 6, "0", "0000000000"], [5, 0, "DDIV", "011110"]],
    format: "DDIV rs, rt [R-type]",
    ...
    architecture: "MIPS III",
    bits: [[31, 26, "SPECIAL", "000000"], [25, 21, "rs", ""], [20, 16, "rt", ""], [15, 6, "0", "0000000000"], [5, 0, "DDIVU", "011111"]],
    format: "DDIVU rs, rt [R-type]",
    ...
    name: "Divide Word",
    architecture: "MIPS I",
    bits: [[31, 26, "SPECIAL", "000000"], [25, 21, "rs", ""], [20, 16, "rt", ""], [15, 6, "0", "0000000000"], [5, 0, "DIV", "011010"]],
    format: "DIV rs, rt [R-type]",
    ...
    architecture: "MIPS I",
    bits: [[31, 26, "SPECIAL", "000000"], [25, 21, "rs", ""], [20, 16, "rt", ""], [15, 6, "0", "0000000000"], [5, 0, "DIVU", "011011"]],
    format: "DIVU rs, rt [R-type]",
    ...
    architecture: "MIPS III",
    bits: [[31, 26, "SPECIAL", "000000"], [25, 21, "rs", ""], [20, 16, "rt", ""], [15, 6, "0", "0000000000"], [5, 0, "DMULT", "011100"]],
    format: "DMULT rs, rt [R-type]",
    ...
    architecture: "MIPS III",
    bits: [[31, 26, "SPECIAL", "000000"], [25, 21, "rs", ""], [20, 16, "rt", ""], [15, 6, "0", "0000000000"], [5, 0, "DMULTU", "011101"]],
    format: "DMULTU rs, rt [R-type]",
    ...
    architecture: "MIPS III",
    bits: [[31, 26, "SPECIAL", "000000"], [25, 21, "0", "00000"], [20, 16, "rt", ""], [15, 11, "rd", ""], [10, 6, "sa", ""], [5, 0, "DSLL", "111000"]],
    format: "DSLL rd, rt, sa [R-type]",
    ...
    architecture: "MIPS III",
    bits: [[31, 26, "SPECIAL", "000000"], [25, 21, "0", "00000"], [20, 16, "rt", ""], [15, 11, "rd", ""], [10, 6, "sa", ""], [5, 0, "DSLL32", "111100"]],
    format: "DSLL32 rd, rt, sa [R-type]",
    ...
    architecture: "MIPS III",
    bits: [[31, 26, "SPECIAL", "000000"], [25, 21, "rs", ""], [20, 16, "rt", ""], [15, 11, "rd", ""], [10, 6, "0", "00000"], [5, 0, "DSLLV", "010100"]],
    format: "DSLLV rd, rt, rs [R-type]",
    ...
    architecture: "MIPS III",
    bits: [[31, 26, "SPECIAL", "000000"], [25, 21, "0", "00000"], [20, 16, "rt", ""], [15, 11, "rd", ""], [10, 6, "sa", ""], [5, 0, "DSRA", "111011"]],
    format: "DSRA rd, rt, sa [R-type]",
    ...
    architecture: "MIPS III",
    bits: [[31, 26, "SPECIAL", "000000"], [25, 21, "0", "00000"], [20, 16, "rt", ""], [15, 11, "rd", ""], [10, 6, "sa", ""], [5, 0, "DSRA32", "111111"]],
    format: "DSRA32 rd, rt, sa [R-type]",
    ...
    architecture: "MIPS III",
    bits: [[31, 26, "SPECIAL", "000000"], [25, 21, "rs", ""], [20, 16, "rt", ""], [15, 11, "rd", ""], [10, 6, "0", "00000"], [5, 0, "DSRAV", "010111"]],
    format: "DSRAV rd, rt, rs [R-type]",
    ...
    architecture: "MIPS III",
    bits: [[31, 26, "SPECIAL", "000000"], [25, 21, "0", "00000"], [20, 16, "rt", ""], [15, 11, "rd", ""], [10, 6, "sa", ""], [5, 0, "DSRL", "111010"]],
    format: "DSRL rd, rt, sa [R-type]",
    ...
    architecture: "MIPS III",
    bits: [[31, 26, "SPECIAL", "000000"], [25, 21, "0", "00000"], [20, 16, "rt", ""], [15, 11, "rd", ""], [10, 6, "sa", ""], [5, 0, "DSRL32", "111110"]],
    format: "DSRL32 rd, rt, sa [R-type]",
    ...
    symbol: "DSRLV",
    name: "Doubleword Shift Right Logical Variable",
    architecture: "MIPS III",
    bits: [[31, 26, "SPECIAL", "000000"], [25, 21, "rs", ""], [20, 16, "rt", ""], [15, 11, "rd", ""], [10, 6, "0", "00000"], [5, 0, "DSRLV", "010110"]],
    format: "DSRLV rd, rt, rs [R-type]",
    purpose: "To logical right shift a doubleword by a variable number of bits.",
    description: "rd <- rt >> rs (logical)<br>The 64-bit doubleword contents of GPR rt are shifted right, inserting zeros into the emptied bits; the result is placed in GPR rd. The bit shift count in the range 0 to 63 is specified by the low-order six bits in GPR rs.",
    restrictions: "None.",
    operation: "64-bit processors:<br>s <- GPR[rs]5..0<br>GPR[rd] <- 0s || GPR[rt]63..s",
    exceptions: "Reserved Instruction",
    programming_notes: "",
    implementation_notes: ""
}, {
    symbol: "DSUB",
    name: "Doubleword Subtract",
    architecture: "MIPS III",
    bits: [[31, 26, "SPECIAL", "000000"], [25, 21, "rs", ""], [20, 16, "rt", ""], [15, 11, "rd", ""], [10, 6, "0", "00000"], [5, 0, "DSUB", "101110"]],
    format: "DSUB rd, rs, rt [R-type]",
    purpose: "To subtract 64-bit integers; trap if overflow.",
    description: "rd <- rs - rt<br>The 64-bit doubleword value in GPR rt is subtracted from the 64-bit value in GPR rs to produce a 64-bit result. If the subtraction results in 64-bit 2's complement arithmetic overflow then the destination register is not modified and an Integer Overflow exception occurs. If it does not overflow, the 64-bit result is placed into GPR rd.",
    restrictions: "None.",
    operation: "64-bit processors:<br>temp <- GPR[rs] - GPR[rt]<br>if (64_bit_arithmetic_overflow) then<br>&emsp;SignalException(IntegerOverflow)<br>else<br>&emsp;GPR[rd] <- temp<br>endif",
    exceptions: "Integer Overflow<br>Reserved Instruction",
    programming_notes: "DSUBU performs the same arithmetic operation but, does not trap on overflow.",
    implementation_notes: ""
}, {
    symbol: "DSUBU",
    name: "Doubleword Subtract Unsigned",
    architecture: "MIPS III",
    bits: [[31, 26, "SPECIAL", "000000"], [25, 21, "rs", ""], [20, 16, "rt", ""], [15, 11, "rd", ""], [10, 6, "0", "00000"], [5, 0, "DSUBU", "101111"]],
    format: "DSUBU rd, rs, rt [R-type]",
    purpose: "To subtract 64-bit integers.",
    description: "rd <- rs - rt<br>The 64-bit doubleword value in GPR rt is subtracted from the 64-bit value in GPR rs and the 64-bit arithmetic result is placed into GPR rd.<br>No Integer Overflow exception occurs under any circumstances.",
    restrictions: "None.",
    operation: "64-bit processors:<br>GPR[rd] <- GPR[rs] - GPR[rt]",
    exceptions: "Reserved Instruction",
    programming_notes: "The term \"unsigned\" in the instruction name is a misnomer; this operation is 64-bit modulo arithmetic that does not trap on overflow. It is appropriate for arithmetic which is not signed, such as address arithmetic, or integer arithmetic environments that ignore overflow, such as \"C\" language arithmetic.",
    ...
    name: "Jump",
    architecture: "MIPS I",
    bits: [[31, 26, "J", "000010"], [25, 0, "target", ""]],
    format: "J target [J-type]",
    ...
    name: "Jump And Link",
    architecture: "MIPS I",
    bits: [[31, 26, "JAL", "000011"], [25, 0, "target", ""]],
    format: "JAL target [J-type]",
    ...
    architecture: "MIPS I",
    bits: [[31, 26, "SPECIAL", "000000"], [25, 21, "rs", ""], [20, 16, "0", "00000"], [15, 11, "rd", ""], [10, 6, "0", "00000"], [5, 0, "JALR", "001001"]],
    format: "JALR rd, rs [R-type]",
    ...
    name: "Jump Register",
    architecture: "MIPS I",
    bits: [[31, 26, "SPECIAL", "000000"], [25, 21, "rs", ""], [20, 6, "0", "000000000000000"], [5, 0, "JR", "001000"]],
    format: "JR rs [R-type]",
    ...
    name: "Load Byte",
    architecture: "MIPS I",
    bits: [[31, 26, "LB", "100000"], [25, 21, "base", ""], [20, 16, "rt", ""], [15, 0, "offset", ""]],
    format: "LB rt, offset(base) [I-type]",
    ...
    architecture: "MIPS I",
    bits: [[31, 26, "LBU", "100100"], [25, 21, "base", ""], [20, 16, "rt", ""], [15, 0, "offset", ""]],
    format: "LBU rt, offset(base) [I-type]",
    ...
    architecture: "MIPS III",
    bits: [[31, 26, "LD", "110111"], [25, 21, "base", ""], [20, 16, "rt", ""], [15, 0, "offset", ""]],
    format: "LD rt, offset(base) [I-type]",
    purpose: "To load a doubleword from memory.",
    description: "rt <- memory[base+offset]<br>The contents of the 64-bit doubleword at the memory location specified by the aligned effective address are fetched and placed in GPR rt. The 16-bit signed offset is added to the contents of GPR base to form the effective address.",
    restrictions: "The effective address must be naturally aligned. If any of the three least-significant bits of the address are non-zero, an Address Error exception occurs.<br>MIPS IV: The low-order 3 bits of the offset field must be zero. If they are not, the result of the instruction is undefined.",
    operation: "64-bit processors:<br>vAddr <- sign_extend(offset) + GPR[base]<br>if (vAddr2..0) !=  03 then SignalException(AddressError) endif<br>(pAddr, uncached) <- AddressTranslation (vAddr, DATA, LOAD)<br>memdouble <- LoadMemory (uncached, DOUBLEWORD, pAddr, vAddr, DATA)<br>GPR[rt] <- memdouble",
    exceptions: "TLB Refill, TLB Invalid<br>Bus Error<br>Address Error<br>Reserved Instruction",
    programming_notes: "",
    implementation_notes: ""
}, {
    symbol: "LDC1",
    ...
    architecture: "MIPS II",
    bits: [[31, 26, "LDC1", "110101"], [25, 21, "base", ""], [20, 16, "rt", ""], [15, 0, "offset", ""]],
    format: "LDC1 rt, offset(base) [I-type]",
    ...
    name: "Load Doubleword to Coprocessor",
    architecture: "MIPS II",
    bits: [[31, 26, "LDC2", "110110"], [25, 21, "base", ""], [20, 16, "rt", ""], [15, 0, "offset", ""]],
    format: "LDC2 rt, offset(base) [I-type]",
    purpose: "To load a doubleword from memory to a coprocessor general register.",
    ...
    symbol: "LDL",
    name: "Load Doubleword Left",
    architecture: "MIPS III",
    bits: [[31, 26, "LDL", "011010"], [25, 21, "base", ""], [20, 16, "rt", ""], [15, 0, "offset", ""]],
    format: "LDL rt, offset(base) [I-type]",
    ...
    restrictions: "None.",
    operation: "64-bit processors:<br>vAddr <- sign_extend(offset) + GPR[base]<br>(pAddr, uncached) <- AddressTranslation (vAddr, DATA, LOAD)<br>pAddr <- pAddr(PSIZE-1)..3 || (pAddr2..0 xor ReverseEndian3)<br>if BigEndianMem = 0 then<br>&emsp;pAddr <- pAddr(PSIZE-1)..3 || 03<br>endif<br>byte <- vAddr2..0 xor BigEndianCPU3<br>memdouble <- LoadMemory (uncached, byte, pAddr, vAddr, DATA)<br>GPR[rt] <- memdouble7+8*byte..0 || GPR[rt]55-8*byte..0",
    exceptions: "TLB Refill, TLB Invalid<br>Bus Error<br>Address Error<br>Reserved Instruction",
    programming_notes: "",
    implementation_notes: ""
}, {
    symbol: "LDR",
    name: "Load Doubleword Right",
    architecture: "MIPS III",
    bits: [[31, 26, "LDR", "011011"], [25, 21, "base", ""], [20, 16, "rt", ""], [15, 0, "offset", ""]],
    format: "LDR rt, offset(base) [I-type]",
    ...
    restrictions: "None.",
    operation: "64-bit processors:<br>vAddr <- sign_extend(offset) + GPR[base]<br>(pAddr, uncached) <- AddressTranslation (vAddr, DATA, LOAD)<br>pAddr <- pAddr(PSIZE-1)..3 || (pAddr2..0 xor ReverseEndian3)<br>if BigEndianMem = 1 then<br>&emsp;pAddr <- pAddr(PSIZE-1)..3 || 03<br>endif<br>byte <- vAddr2..0 xor BigEndianCPU3<br>memdouble <- LoadMemory (uncached, byte, pAddr, vAddr, DATA)<br>GPR[rt] <- GPR[rt]63..64-8*byte || memdouble63..8*byte",
    exceptions: "TLB Refill, TLB Invalid<br>Bus Error<br>Address Error<br>Reserved Instruction",
    programming_notes: "",
    implementation_notes: ""
}, {
    ...
    name: "Load Halfword",
    architecture: "MIPS I",
    bits: [[31, 26, "LH", "100001"], [25, 21, "base", ""], [20, 16, "rt", ""], [15, 0, "offset", ""]],
    format: "LH rt, offset(base) [I-type]",
    ...
    architecture: "MIPS I",
    bits: [[31, 26, "LHU", "100101"], [25, 21, "base", ""], [20, 16, "rt", ""], [15, 0, "offset", ""]],
    format: "LHU rt, offset(base) [I-type]",
    ...
    name: "Load Word",
    architecture: "MIPS I",
    bits: [[31, 26, "LW", "100011"], [25, 21, "base", ""], [20, 16, "rt", ""], [15, 0, "offset", ""]],
    format: "LW rt, offset(base) [I-type]",
    ...
    architecture: "MIPS I",
    bits: [[31, 26, "LWC1", "110001"], [25, 21, "base", ""], [20, 16, "rt", ""], [15, 0, "offset", ""]],
    format: "LWC1 rt, offset(base) [I-type]",
    ...
    name: "Load Word To Coprocessor",
    architecture: "MIPS I",
    bits: [[31, 26, "LWC2", "110010"], [25, 21, "base", ""], [20, 16, "rt", ""], [15, 0, "offset", ""]],
    format: "LWC2 rt, offset(base) [I-type]",
    purpose: "To load a word from memory to a coprocessor general register.",
    ...
    name: "Load Word To Coprocessor",
    architecture: "MIPS I",
    bits: [[31, 26, "LWC3", "110011"], [25, 21, "base", ""], [20, 16, "rt", ""], [15, 0, "offset", ""]],
    format: "LWC3 rt, offset(base) [I-type]",
    purpose: "To load a word from memory to a coprocessor general register.",
    ...
    name: "Load Word Left",
    architecture: "MIPS I",
    bits: [[31, 26, "LWL", "100010"], [25, 21, "base", ""], [20, 16, "rt", ""], [15, 0, "offset", ""]],
    format: "LWL rt, offset(base) [I-type]",
    ...
    architecture: "MIPS I",
    bits: [[31, 26, "LWR", "100110"], [25, 21, "base", ""], [20, 16, "rt", ""], [15, 0, "offset", ""]],
    format: "LWR rt, offset(base) [I-type]",
    purpose: "",
    ...
    architecture: "MIPS III",
    bits: [[31, 26, "LWU", "100111"], [25, 21, "base", ""], [20, 16, "rt", ""], [15, 0, "offset", ""]],
    format: "LWU rt, offset(base) [I-type]",
    purpose: "To load a word from memory as an unsigned value.",
    description: "rt <- memory[base+offset]<br>The contents of the 32-bit word at the memory location specified by the aligned effective address are fetched, zero-extended, and placed in GPR rt. The 16-bit signed offset is added to the contents of GPR base to form the effective address.",
    restrictions: "The effective address must be naturally aligned. If either of the two least-significant bits of the address are non-zero, an Address Error exception occurs.<br>MIPS IV: The low-order 2 bits of the offset field must be zero. If they are not, the result of the instruction is undefined.",
    operation: "64-bit processors:<br>vAddr <- sign_extend(offset) + GPR[base]<br>if (vAddr1..0) !=  02 then SignalException(AddressError) endif<br>(pAddr, uncached) <- AddressTranslation (vAddr, DATA, LOAD)<br>pAddr <- pAddrPSIZE-1..3 || (pAddr2..0 xor (ReverseEndian || 02))<br>memdouble <- LoadMemory (uncached, WORD, pAddr, vAddr, DATA)<br>byte <- vAddr2..0 xor (BigEndianCPU || 02)<br>GPR[rt] <- 032 || memdouble31+8*byte..8*byte",
    exceptions: "TLB Refill, TLB Invalid<br>Bus Error<br>Address Error<br>Reserved Instruction",
    programming_notes: "",
    implementation_notes: ""
}, {
    ...
    architecture: "MIPS I",
    bits: [[31, 26, "SPECIAL", "000000"], [25, 16, "0", "0000000000"], [15, 11, "rd", ""], [10, 6, "0", "00000"], [5, 0, "MFHI", "010000"]],
    format: "MFHI rd [R-type]",
    ...
    architecture: "MIPS I",
    bits: [[31, 26, "SPECIAL", "000000"], [25, 16, "0", "0000000000"], [15, 11, "rd", ""], [10, 6, "0", "00000"], [5, 0, "MFLO", "010010"]],
    format: "MFLO rd [R-type]",
    ...
    symbol: "MOVN",
    name: "Move Conditional on Not Zero",
    architecture: "MIPS IV",
    bits: [[31, 26, "SPECIAL", "000000"], [25, 21, "rs", ""], [20, 16, "rt", ""], [15, 11, "rd", ""], [10, 6, "0", "00000"], [5, 0, "MOVN", "001011"]],
    format: "MOVN rd, rs, rt [R-type]",
    purpose: "To conditionally move a GPR after testing a GPR value.",
    description: "if (rt !=  0) then rd <- rs<br>If the value in GPR rt is not equal to zero, then the contents of GPR rs are placed into GPR rd.",
    restrictions: "None.",
    operation: "if GPR[rt] !=  0 then<br>&emsp;GPR[rd] <- GPR[rs]<br>endif",
    exceptions: "Reserved Instruction",
    programming_notes: "The nonzero value tested here is the \"condition true\" result from the SLT, SLTI, SLTU, and SLTIU comparison instructions.",
    implementation_notes: ""
}, {
    symbol: "MOVZ",
    name: "Move Conditional on Zero",
    architecture: "MIPS IV",
    bits: [[31, 26, "SPECIAL", "000000"], [25, 21, "rs", ""], [20, 16, "rt", ""], [15, 11, "rd", ""], [10, 6, "0", "00000"], [5, 0, "MOVZ", "001010"]],
    format: "MOVZ rd, rs, rt [R-type]",
    purpose: "To conditionally move a GPR after testing a GPR value.",
    description: "if (rt = 0) then rd <- rs<br>If the value in GPR rt is equal to zero, then the contents of GPR rs are placed into GPR rd.",
    restrictions: "None.",
    operation: "if GPR[rt] = 0 then<br>&emsp;GPR[rd] <- GPR[rs]<br>endif",
    exceptions: "Reserved Instruction",
    programming_notes: "The zero value tested here is the \"condition false\" result from the SLT, SLTI, SLTU, and SLTIU comparison instructions.",
    implementation_notes: ""
}, {
    symbol: "MTHI",
    name: "Move To HI Register",
    architecture: "MIPS I",
    bits: [[31, 26, "SPECIAL", "000000"], [25, 21, "rs", ""], [20, 6, "0", "000000000000000"], [5, 0, "MTHI", "010001"]],
    format: "MTHI rs [R-type]",
    ...
    architecture: "MIPS I",
    bits: [[31, 26, "SPECIAL", "000000"], [25, 21, "rs", ""], [20, 6, "0", "000000000000000"], [5, 0, "MTLO", "010011"]],
    format: "MTLO rs [R-type]",
    ...
    name: "Multiply Word",
    architecture: "MIPS I",
    bits: [[31, 26, "SPECIAL", "000000"], [25, 21, "rs", ""], [20, 16, "rt", ""], [15, 6, "0", "0000000000"], [5, 0, "MULT", "011000"]],
    format: "MULT rs, rt [R-type]",
    ...
    architecture: "MIPS I",
    bits: [[31, 26, "SPECIAL", "000000"], [25, 21, "rs", ""], [20, 16, "rt", ""], [15, 6, "0", "0000000000"], [5, 0, "MULTU", "011001"]],
    format: "MULTU rs, rt [R-type]",
    ...
    name: "Not Or",
    architecture: "MIPS I",
    bits: [[31, 26, "SPECIAL", "000000"], [25, 21, "rs", ""], [20, 16, "rt", ""], [15, 11, "rd", ""], [10, 6, "0", "00000"], [5, 0, "NOR", "100111"]],
    ...
    name: "Or",
    architecture: "MIPS I",
    bits: [[31, 26, "SPECIAL", "000000"], [25, 21, "rs", ""], [20, 16, "rt", ""], [15, 11, "rd", ""], [10, 6, "0", "00000"], [5, 0, "OR", "100101"]],
    format: "OR rd, rs, rt [R-type]",
    ...
    name: "Or Immediate",
    architecture: "MIPS I",
    bits: [[31, 26, "ORI", "001101"], [25, 21, "rs", ""], [20, 16, "rt", ""], [15, 0, "immediate", ""]],
    format: "ORI rt, rs, immediate [I-type]",
    ...
    architecture: "MIPS II",
    bits: [[31, 26, "SC", "111000"], [25, 21, "base", ""], [20, 16, "rt", ""], [15, 0, "offset", ""]],
    format: "SC rt, offset(base) [I-type]",
    ...
    architecture: "MIPS II",
    bits: [[31, 26, "SDC1", "111101"], [25, 21, "base", ""], [20, 16, "rt", ""], [15, 0, "offset", ""]],
    format: "SDC1 rt, offset(base) [I-type]",
    ...
    name: "Store Doubleword From Coprocessor",
    architecture: "MIPS II",
    bits: [[31, 26, "SDC2", "111110"], [25, 21, "base", ""], [20, 16, "rt", ""], [15, 0, "offset", ""]],
    format: "SDC2 rt, offset(base) [I-type]",
    purpose: "To store a doubleword from a coprocessor general register to memory.",
    ...
    restrictions: "None.",
    operation: "64-bit processors:<br>vAddr <- sign_extend(offset) + GPR[base]<br>(pAddr, uncached) <- AddressTranslation (vAddr, DATA, STORE)<br>pAddr <- pAddr(PSIZE-1)..3 || (pAddr2..0 xor ReverseEndian3)<br>If BigEndianMem = 0 then<br>&emsp;pAddr <- pAddr(PSIZE-1)..3 || 03<br>endif<br>byte <- vAddr1..0 xor BigEndianCPU3<br>datadouble <- GPR[rt]63-8*byte || 08*byte<br>StoreMemory (uncached, DOUBLEWORD-byte, datadouble, pAddr, vAddr, DATA)",
    exceptions: "TLB Refill, TLB Invalid<br>TLB Modified<br>Bus Error<br>Address Error<br>Reserved Instruction",
    programming_notes: "",
    implementation_notes: ""
}, {
    ...
    name: "Store Halfword",
    architecture: "MIPS I",
    bits: [[31, 26, "SH", "101001"], [25, 21, "base", ""], [20, 16, "rt", ""], [15, 0, "offset", ""]],
    format: "SH rt, offset(base) [I-type]",
    ...
    architecture: "MIPS I",
    bits: [[31, 26, "SPECIAL", "000000"], [25, 21, "0", "00000"], [20, 16, "rt", ""], [15, 11, "rd", ""], [10, 6, "sa", ""], [5, 0, "SLL", "000000"]],
    format: "SLL rd, rt, sa [R-type]",
    ...
    architecture: "MIPS I",
    bits: [[31, 26, "SPECIAL", "000000"], [25, 21, "rs", ""], [20, 16, "rt", ""], [15, 11, "rd", ""], [10, 6, "0", "00000"], [5, 0, "SLLV", "000100"]],
    format: "SLLV rd, rt, rs [R-type]",
    ...
    architecture: "MIPS I",
    bits: [[31, 26, "SPECIAL", "000000"], [25, 21, "rs", ""], [20, 16, "rt", ""], [15, 11, "rd", ""], [10, 6, "0", "00000"], [5, 0, "SLT", "101010"]],
    format: "SLT rd, rs, rt [R-type]",
    ...
    architecture: "MIPS I",
    bits: [[31, 26, "SLTI", "001010"], [25, 21, "rs", ""], [20, 16, "rt", ""], [15, 0, "immediate", ""]],
    format: "SLTI rt, rs, immediate [I-type]",
    ...
    architecture: "MIPS I",
    bits: [[31, 26, "SLTIU", "001011"], [25, 21, "rs", ""], [20, 16, "rt", ""], [15, 0, "immediate", ""]],
    format: "SLTIU rt, rs, immediate [I-type]",
    ...
    architecture: "MIPS I",
    bits: [[31, 26, "SPECIAL", "000000"], [25, 21, "rs", ""], [20, 16, "rt", ""], [15, 11, "rd", ""], [10, 6, "0", "00000"], [5, 0, "SLTU", "101011"]],
    format: "SLTU rd, rs, rt [R-type]",
    ...
    architecture: "MIPS I",
    bits: [[31, 26, "SPECIAL", "000000"], [25, 21, "0", "00000"], [20, 16, "rt", ""], [15, 11, "rd", ""], [10, 6, "sa", ""], [5, 0, "SRA", "000011"]],
    format: "SRA rd, rt, sa [R-type]",
    ...
    architecture: "MIPS I",
    bits: [[31, 26, "SPECIAL", "000000"], [25, 21, "rs", ""], [20, 16, "rt", ""], [15, 11, "rd", ""], [10, 6, "0", "00000"], [5, 0, "SRAV", "000111"]],
    format: "SRAV rd, rt, rs [R-type]",
    ...
    architecture: "MIPS I",
    bits: [[31, 26, "SPECIAL", "000000"], [25, 21, "0", "00000"], [20, 16, "rt", ""], [15, 11, "rd", ""], [10, 6, "sa", ""], [5, 0, "SRL", "000010"]],
    ...
    architecture: "MIPS I",
    bits: [[31, 26, "SPECIAL", "000000"], [25, 21, "rs", ""], [20, 16, "rt", ""], [15, 11, "rd", ""], [10, 6, "0", "00000"], [5, 0, "SRLV", "000110"]],
    format: "SRLV rd, rt, rs [R-type]",
    ...
    name: "Subtract Word",
    architecture: "MIPS I",
    bits: [[31, 26, "SPECIAL", "000000"], [25, 21, "rs", ""], [20, 16, "rt", ""], [15, 11, "rd", ""], [10, 6, "0", "00000"], [5, 0, "SUB", "100010"]],
    format: "SUB rd, rs, rt [R-type]",
    ...
    architecture: "MIPS I",
    bits: [[31, 26, "SPECIAL", "000000"], [25, 21, "rs", ""], [20, 16, "rt", ""], [15, 11, "rd", ""], [10, 6, "0", "00000"], [5, 0, "SUBU", "100011"]],
    format: "SUBU rd, rs, rt [R-type]",
    ...
    name: "Store Word",
    architecture: "MIPS I",
    bits: [[31, 26, "SW", "101011"], [25, 21, "base", ""], [20, 16, "rt", ""], [15, 0, "offset", ""]],
    format: "SW rt, offset(base) [I-type]",
    ...
    architecture: "MIPS I",
    bits: [[31, 26, "SWC1", "111001"], [25, 21, "base", ""], [20, 16, "rt", ""], [15, 0, "offset", ""]],
    format: "SWC1 rt, offset(base) [I-type]",
    ...
    name: "Store Word From Coprocessor",
    architecture: "MIPS I",
    bits: [[31, 26, "SWC2", "111010"], [25, 21, "base", ""], [20, 16, "rt", ""], [15, 0, "offset", ""]],
    format: "SWC2 rt, offset(base) [I-type]",
    purpose: "To store a word from a coprocessor general register to memory.",
    ...
    name: "Store Word From Coprocessor",
    architecture: "MIPS I",
    bits: [[31, 26, "SWC3", "111011"], [25, 21, "base", ""], [20, 16, "rt", ""], [15, 0, "offset", ""]],
    format: "SWC3 rt, offset(base) [I-type]",
    purpose: "To store a word from a coprocessor general register to memory.",
    ...
    architecture: "MIPS I",
    bits: [[31, 26, "SWL", "101010"], [25, 21, "base", ""], [20, 16, "rt", ""], [15, 0, "offset", ""]],
    format: "SWL rt, offset(base) [I-type]",
    ...
    architecture: "MIPS I",
    bits: [[31, 26, "SWR", "101110"], [25, 21, "base", ""], [20, 16, "rt", ""], [15, 0, "offset", ""]],
    format: "SWR rt, offset(base) [I-type]",
    ...
    name: "Trap if Equal",
    architecture: "MIPS II",
    bits: [[31, 26, "SPECIAL", "000000"], [25, 21, "rs", ""], [20, 16, "rt", ""], [15, 6, "code", ""], [5, 0, "TEQ", "110100"]],
    format: "TEQ rs, rt [R-type]",
    ...
    symbol: "TEQI",
    name: "Trap if Equal Immediate",
    architecture: "MIPS II",
    bits: [[31, 26, "REGIMM", "000001"], [25, 21, "rs", ""], [20, 16, "TEQI", "01100"], [15, 0, "immediate", ""]],
    format: "TEQI rs, immediate [I-type]",
    purpose: "To compare a GPR to a constant and do a conditional Trap.",
    description: "if (rs = immediate) then Trap<br>Compare the contents of GPR rs and the 16-bit signed immediate as signed integers; if GPR rs is equal to immediate then take a Trap exception.",
    restrictions: "None.",
    operation: "if GPR[rs] = sign_extend(immediate) then<br>&emsp;SignalException(Trap)<br>endif",
    exceptions: "Reserved Instruction<br>Trap",
    programming_notes: "",
    implementation_notes: ""
}, {
    ...
    architecture: "MIPS II",
    bits: [[31, 26, "SPECIAL", "000000"], [25, 21, "rs", ""], [20, 16, "rt", ""], [15, 6, "code", ""], [5, 0, "TGE", "110000"]],
    format: "TGE rs, rt [R-type]",
    purpose: "To compare GPRs and do a conditional Trap.",
    ...
    symbol: "TGEI",
    name: "Trap if Greater or Equal Immediate",
    architecture: "MIPS II",
    bits: [[31, 26, "REGIMM", "000001"], [25, 21, "rs", ""], [20, 16, "TGEI", "01000"], [15, 0, "immediate", ""]],
    format: "TGEI rs, immediate [I-type]",
    purpose: "To compare a GPR to a constant and do a conditional Trap.",
    description: "if (rs >= immediate) then Trap<br>Compare the contents of GPR rs and the 16-bit signed immediate as signed integers; if GPR rs is greater than or equal to immediate then take a Trap exception.",
    restrictions: "None.",
    operation: "if GPR[rs] >= sign_extend(immediate) then<br>&emsp;SignalException(Trap)<br>endif",
    exceptions: "Reserved Instruction<br>Trap",
    programming_notes: "",
    ...
    symbol: "TGEIU",
    name: "Trap If Greater Or Equal Immediate Unsigned",
    architecture: "MIPS II",
    bits: [[31, 26, "REGIMM", "000001"], [25, 21, "rs", ""], [20, 16, "TGEIU", "01001"], [15, 0, "immediate", ""]],
    format: "TGEIU rs, immediate [I-type]",
    purpose: "To compare a GPR to a constant and do a conditional Trap.",
    ...
    restrictions: "None.",
    operation: "if (0 || GPR[rs]) >= (0 || sign_extend(immediate)) then<br>&emsp;SignalException(Trap)<br>endif",
    exceptions: "Reserved Instruction<br>Trap",
    programming_notes: "",
    implementation_notes: ""
}, {
    ...
    architecture: "MIPS II",
    bits: [[31, 26, "SPECIAL", "000000"], [25, 21, "rs", ""], [20, 16, "rt", ""], [15, 6, "code", ""], [5, 0, "TGEU", "110001"]],
    format: "TGEU rs, rt [R-type]",
    purpose: "To compare GPRs and do a conditional Trap.",
    ...
    architecture: "MIPS II",
    bits: [[31, 26, "SPECIAL", "000000"], [25, 21, "rs", ""], [20, 16, "rt", ""], [15, 6, "code", ""], [5, 0, "TLT", "110010"]],
    format: "TLT rs, rt [R-type]",
    purpose: "To compare GPRs and do a conditional Trap.",
    ...
    symbol: "TLTI",
    name: "Trap if Less Than Immediate",
    architecture: "MIPS II",
    bits: [[31, 26, "REGIMM", "000001"], [25, 21, "rs", ""], [20, 16, "TLTI", "01010"], [15, 0, "immediate", ""]],
    format: "TLTI rs, immediate [I-type]",
    purpose: "To compare a GPR to a constant and do a conditional Trap.",
    description: "if (rs < immediate) then Trap<br>Compare the contents of GPR rs and the 16-bit signed immediate as signed integers; if GPR rs is less than immediate then take a Trap exception.",
    restrictions: "None.",
    operation: "if GPR[rs] < sign_extend(immediate) then<br>&emsp;SignalException(Trap)<br>endif",
    exceptions: "Reserved Instruction<br>Trap",
    programming_notes: "",
    ...
    symbol: "TLTIU",
    name: "Trap if Less Than Immediate Unsigned",
    architecture: "MIPS II",
    bits: [[31, 26, "REGIMM", "000001"], [25, 21, "rs", ""], [20, 16, "TLTIU", "01011"], [15, 0, "immediate", ""]],
    format: "TLTIU rs, immediate [I-type]",
    purpose: "To compare a GPR to a constant and do a conditional Trap.",
    ...
    architecture: "MIPS II",
    bits: [[31, 26, "SPECIAL", "000000"], [25, 21, "rs", ""], [20, 16, "rt", ""], [15, 6, "code", ""], [5, 0, "TLTU", "110011"]],
    format: "TLTU rs, rt [R-type]",
    purpose: "To compare GPRs and do a conditional Trap.",
    ...
    architecture: "MIPS II",
    bits: [[31, 26, "SPECIAL", "000000"], [25, 21, "rs", ""], [20, 16, "rt", ""], [15, 6, "code", ""], [5, 0, "TNE", "110110"]],
    format: "TNE rs, rt [R-type]",
    purpose: "To compare GPRs and do a conditional Trap.",
    ...
    symbol: "TNEI",
    name: "Trap if Not Equal Immediate",
    architecture: "MIPS II",
    bits: [[31, 26, "REGIMM", "000001"], [25, 21, "rs", ""], [20, 16, "TNEI", "01110"], [15, 0, "immediate", ""]],
    format: "TNEI rs, immediate [I-type]",
    purpose: "To compare a GPR to a constant and do a conditional Trap.",
    description: "if (rs !=  immediate) then Trap<br>Compare the contents of GPR rs and the 16-bit signed immediate as signed integers; if GPR rs is not equal to immediate then take a Trap exception.",
    restrictions: "None.",
    operation: "if GPR[rs] !=  sign_extend(immediate) then<br>&emsp;SignalException(Trap)<br>endif",
    exceptions: "Reserved Instruction<br>Trap",
    programming_notes: "",
    ...
    name: "Exclusive OR",
    architecture: "MIPS I",
    bits: [[31, 26, "SPECIAL", "000000"], [25, 21, "rs", ""], [20, 16, "rt", ""], [15, 11, "rd", ""], [10, 6, "0", "00000"], [5, 0, "XOR", "100110"]],
    format: "XOR rd, rs, rt [R-type]",
    ...
    architecture: "MIPS I",
    bits: [[31, 26, "XORI", "001110"], [25, 21, "rs", ""], [20, 16, "rt", ""], [15, 0, "immediate", ""]],
    format: "XORI rt, rs, immediate [I-type]",
